...
export const BRATISLAVA_VENUES_INVENTORY: BratislavaVenueImport[] = [
  ...
  },
  {
    ...
    description:
      'NTC / Peugeot Aréna — 8 krytých tenisových kurtov, bedminton, squash; Davis Cup, STZ turnaje a verejný prenájom v Novom Meste.',
    ...
    longitude: 17.13456,
    verified: true,
    amenities: { parking: true, showers: true, floodlights: true, proShop: true, restaurant: true },
    openingHours: { mon_fri: '07:00-22:00', saturday: '08:00-21:00', sunday: '08:00-21:00' },
    source: 'https://www.ntc.sk/',
  },
  {
