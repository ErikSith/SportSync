...
export const VENUE_SEEDS: Array<{
  ...
  },
  {
    ...
    latitude: 48.1486,
    longitude: 17.1077,
    websiteUrl: 'https://arenapadel.sk/',
    district: 'ruzinov',
  },
  {
    key: 'ntc-kosice',
  ...
  },
  {
    key: 'ofa-mma',
    name: 'OFA Gym',
    address: 'Ivanská cesta 10/188, Bratislava',
    city: 'Bratislava',
    sports: ['COMBAT'],
    latitude: 48.1568,
    longitude: 17.1785,
    websiteUrl: 'https://www.ofa-gym.sk/',
    district: 'ruzinov',
  },
  {
    key: 'chaos-mma',
    name: 'Chaos MMA',
    address: 'Ivanská cesta 26, Bratislava',
    city: 'Bratislava',
    sports: ['COMBAT'],
    latitude: 48.155,
    longitude: 17.12,
    websiteUrl: 'https://mammal.sk/clenovia/kolektivni-clenovia/chaos-bratislava/',
    district: 'ruzinov',
  },
  {
    key: 'prostor',
    name: 'CrossFit Proton',
    address: 'Turbínová 1, Bratislava',
    city: 'Bratislava',
    sports: ['FITNESS'],
    latitude: 48.1435,
    longitude: 17.1278,
    websiteUrl: 'https://www.crossfitproton.sk/',
    district: 'ruzinov',
  },
  {
    key: 'wakelake',
  ...
  },
  {
    ...
    latitude: 48.15,
    longitude: 17.11,
    websiteUrl: 'http://www.bowlingpbc.sk/',
    district: 'petrzalka',
  },
  {
    key: 'bnc-ba',
    ...
    latitude: 48.151,
    longitude: 17.112,
    websiteUrl: 'https://www.bnc-sk.sk/',
    district: 'nove-mesto',
  },
  {
    key: 'sipky-sk',
    ...
    latitude: 48.1486,
    longitude: 17.1077,
    websiteUrl: 'https://www.slovakiadart.sk/',
    district: 'stare-mesto',
  },
  {
    key: 'ba-marathon',
