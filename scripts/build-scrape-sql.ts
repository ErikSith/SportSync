...
FROM (VALUES
  ('Aurial Padel Bratislava', 'Bajkalská 7, Bratislava', 'Bratislava', ARRAY['PADEL'], 48.1569, 17.1402, 'https://aurialpadel.sk/'),
  ('Aurial Padel Rača', 'Na Pántoch 8, Bratislava', 'Bratislava', ARRAY['PADEL'], 48.2045, 17.1508, 'https://aurialpadel.sk/'),
  ('Form Factory FitCamp', 'Drieňová 11/A, Bratislava', 'Bratislava', ARRAY['FITNESS'], 48.1562, 17.1475, 'https://fitcamp.formfactory.sk/'),
